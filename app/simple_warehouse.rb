...
require './app/services/warehouse_locator'
require './app/services/warehouse_remover'
require './app/services/warehouse_viewer'
...
class SimpleWarehouse
  def initialize
    ...
    warehouse_locator = WarehouseLocator.new
    warehouse_remover = WarehouseRemover.new
    warehouse_viewer = WarehouseViewer.new
    ...
    @cmd_executor.add_command SimpleWarehouseConstants::LOCATE_CMD, LocateProduct.new(warehouse_reader, warehouse_locator)
    @cmd_executor.add_command SimpleWarehouseConstants::REMOVE_CMD, RemoveCrate.new(warehouse_reader, warehouse_remover)

    @cmd_executor.add_command SimpleWarehouseConstants::VIEW_CMD, View.new(warehouse_viewer)
